...
load([filepath 'Shimada\Data\summary_19-23Hake_cells'],'P'); %IFCB data
...
if fprint
    exportgraphics(fig,[filepath 'plotting-quickstart\heatmap_CCS\Figs\' name '_cells_CCS_heatmap_' num2str(yr) '.png'],'Resolution',100)    
end
hold off 
