...
% used to evaluate differences in IFCB detection settings
...
load([filepath 'Budd Inlet\Data\eqdiam_biovol_2021'],'ESD','matdate','filecomment','runtype');
...
load([filepath 'Budd Inlet\Data\eqdiam_biovol_2022'],'ESD','matdate','filecomment','runtype');
dt=datetime(matdate,'convertfrom','datenum');
