...
ml_analyzed = NaN(length(filelistTB),1);
...
for i = 1:length(filelistTB)
    ...
    biovol = feastruct.data(:,ind)*micron_factor.^3;
...
save([summarydir 'class_cells_biovol_eqdiam_sizethresh'], 'ClBiEq', 'note1', 'note2', 'note3')
