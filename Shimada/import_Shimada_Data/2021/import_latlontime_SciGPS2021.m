...
% Stephanie K. Moore modified import_latlontime_SciGPS2021.m by Alexis D. Fischer

clear;
filepath='C:\Users\Stephanie.Moore\Documents\GitHub\spawn-of-baby-bloom\'; %USER
indir=[filepath 'Shimada\import_Shimada_Data\2021\GPS - Science GP170\']; %USER
...
for i=1:length(LATdir)
    ...
    if date < datetime(2021,08,13)
        ...
        dt = datetime(tbl.ACQTimestampServerTimeInUTC,"InputFormat",'yyyy-MM-dd HH:mm:ss''Z');
        dt.Format='yyyy-MM-dd HH:mm:ss';           
        lat = tbl.VarName4;
    
        tbl = readtable(filelon, opts);         
        dt_lon = datetime(tbl.ACQTimestampServerTimeInUTC,"InputFormat",'yyyy-MM-dd HH:mm:ss''Z');
...
save([outpath 'lat_lon_time_Shimada2021'],'TT');
