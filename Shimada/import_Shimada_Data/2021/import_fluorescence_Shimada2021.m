...
% Stephanie K. Moore modified import_flourescence_Shimada2021.m by Alexis D. Fischer

clear;
filepath='C:\Users\Stephanie.Moore\Documents\GitHub\spawn-of-baby-bloom\'; %USER
indir=[filepath 'Shimada\import_Shimada_Data\2021\Seawater System - Fluorometer\']; %USER
...
for i=1:length(Tdir)
    ...
    if date < datetime(2021,09,03)
        ...
        opts.VariableTypes = ["string", "string", "categorical", "double", "double", "datetime", "datetime", "double", "categorical", "double", "categorical"];
        opts.ExtraColumnsRule = "ignore";
        opts.EmptyLineRule = "read";
        opts.ConsecutiveDelimitersRule = "join";
        opts = setvaropts(opts, ["ACQ", "Timestamp"], "WhitespaceRule", "preserve");
        opts = setvaropts(opts, ["ACQ", "Timestamp", "Server", "Value", "Fluorometer6993RTDMessage"], "EmptyFieldRule", "auto");
        ...
        dti = datetime(tbl.ACQ+tbl.Timestamp,"InputFormat",'yyyy-MM-ddHH:mm:ss''Z');
